...
- **GPT-4 Natural Language Understanding**: Хэрэглэгчийн мессежийг байгалийн хэлээр ойлгож, шалтгааныг автоматаар танина
- **Keyword-free parsing**: Тогтсон үгс ашиглахгүйгээр контекстээс ойлгож авна
- **Description талбар**: External API руу илгээхдээ шалтгааныг монгол хэлээр илгээнэ
- **Manager руу илгээх**: Шалтгааныг manager-т харуулна
- **Fallback механизм**: GPT ашиглах боломжгүй үед энгийн keyword check ашиглана
